...
air_data_2d_r = read.csv("Air_Data_2D.csv",header=TRUE,row.names=1)
uwind_data_2d_r = read.csv("Uwind_Data_2D.csv",header=TRUE,row.names=1)
rel_humid_data_2d_r = read.csv("Rel_Humid_Data_2D.csv",header=TRUE,row.names=1)
sp_humid_data_2d_r = read.csv("Sp_Humid_Data_2D.csv",header=TRUE,row.names=1)
vwind_data_2d_r = read.csv("Vwind_Data_2D.csv",header=TRUE,row.names=1)


air_data_2d=air_data_2d_r[10958:15340,]
uwind_data_2d= uwind_data_2d_r[10958:15340,]
vwind_data_2d=vwind_data_2d_r[10958:15340,]
rel_humid_data_2d=rel_humid_data_2d_r[10958:15340,]
sp_humid_data_2d=sp_humid_data_2d_r[10958:15340,]
...
write.csv(corr_air_sp_humid_frame2,"Corr_Last10_Combined.csv")
